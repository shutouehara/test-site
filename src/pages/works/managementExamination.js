    ...
    <Layout>
      <div className="child-page-wrapper pt-5 mb-5">
        <section className="mt-5 p-5">
          ...
          <p>入札参加資格審査申請の確認はこちらから</p>
          <p>経営規模等評価申請を申請するまでに、経営状況分析を経ている必要があります。<br />
              経営状況分析申請を行ってから、経営規模等評価申請を以って経営事項審査申請となります。</p>
          <nav>
            <ul className="page-navi-list ps-3">
              <li className="position-relative d-inline-block me-5"><Link to="#examination"><span>経営規模等評価申請（経審）</span></Link></li>
              <li className="position-relative d-inline-block"><Link to="#managementAnalysis"><span>経営状況分析申請</span></Link></li>
            </ul>
          </nav>
        </section>
        <section id="examination" className="scroll-target mt-5 px-5 pb-5">
          <h2 className="pb-1 border-bottom border-5 border-dark fw-bold">経営規模等評価申請（経審）</h2>

          <h3 className="mt-5 mb-3 position-relative">経営規模等評価申請（経審）について</h3>
        ...
        <section id="managementAnalysis" className="scroll-target mt-5 px-5 pb-5">
          ...
          <p>建設業許可を受けた事業者は、毎年期日までに年度報告書を県に提出する必要があります。
期限は、事業年度終了後から4ヶ月以内。
12月末決算の場合は翌年の4月末が期限に、3月末決算の場合は7月末が期限になります。</p>
          ...
          <ol className="list-has-head">
            <li>
              ...
              建設業許可は5年に1度更新が必要となります。その際、年度報告書の未提出が確認されると、建設業許可の更新手続きができない場合があります。
また、許可業種の追加申請の際にも、年度報告書の未提出が原因で受け付けてもらえない場合があります。
            </li>
            <li>
              <h4>取引先や銀行への業績証明が不可能となり、信用を損なう。</h4>
              年度報告書を提出しない場合、取引先が行政を通して業務状況や業績情報を確認することができません。
